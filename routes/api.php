...
use App\Http\Controllers\API\WpOrg\Plugins\PluginController;
...
Route::prefix('/')
    ->group(function (Router $r) {
        ...
        $r->get('/plugins/info/{version}', CatchAllController::class)->where(['version' => '1.[01]']);
        $r->get('/plugins/update-check/{version}', CatchAllController::class)->where(['version' => '1.[01]']);
        $r->get('/plugins/info/{version}', [PluginController::class, 'info'])->where(['version' => '1.[012]']);
        $r->get('/plugins/update-check/{version}', [PluginController::class, 'update_check'])->where(['version' => '1.[012]']);
